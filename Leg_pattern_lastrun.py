...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Skoltech\\Neuro LAB\\Osteoprothesis\\osseointegration_psychopy_arms-master\\arm\\Leg_pattern\\Vladik\\last\\Leg_pattern_lastrun.py',
